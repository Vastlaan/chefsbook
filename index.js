...
mongoose.connect(keys.mongoURI); // here we pass url to our database togheter with username and password. We can find it in our key values

// middleware before routes
app.use(
    cookieSession({
        // this stores all our data in the cookie itself. We can store mak 4KB of data in session
